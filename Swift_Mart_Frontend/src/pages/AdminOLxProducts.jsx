...
const AdminOlxProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const response = await fetch(`http://localhost:8080/api/admin/olx-products?status=${filter}`, {
        method: 'GET',
        credentials: 'include',
      });
  ...
  const handleApprove = async (productId) => {
    try {
      ...
      const response = await fetch(`http://localhost:8080/api/admin/olx-products/approve`, {
        method: 'POST',
        headers: {
  ...
  const handleReject = async (productId) => {
    try {
      ...
      const response = await fetch(`http://localhost:8080/api/admin/olx-products/reject`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
